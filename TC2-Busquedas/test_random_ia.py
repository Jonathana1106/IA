...
def announce_winner(p1_choice, p2_choice):
    ...
    """
    if gameover(board, PC):  # Check if Random AI wins
        print('PLAYER IA RANDOM WINS!')
    elif gameover(board, PC2):  # Check if Minimax AI wins
...
def iaturn1(p1_choice, p2_choice):
    """
    Executes the AI player's turn for Player 1 (Random) in the game.
    ...
    domove(x, y, PC)  # Note: PC is used here to represent Player 1 (Random)
    time.sleep(1)
