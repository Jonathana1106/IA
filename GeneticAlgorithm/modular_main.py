...
def generate_pointillism_image(
    ...
    if gradient_smoothing_radius == 0:
        ...
        print("Radio de suavizado de gradientes automáticamente seleccionado: %d" % gradient_smoothing_radius)
...
def main(palette_size=20, stroke_scale=0, gradient_smoothing_radius=0, limit_image_size=0, img_path="GeneticAlgorithm/img/sansiro.png"):
    ...
    generated_image = generate_pointillism_image(
        args.img_path,
        args.palette_size,
        args.stroke_scale,
        args.gradient_smoothing_radius,
